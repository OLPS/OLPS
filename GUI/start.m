...
% Last Modified by GUIDE v2.5 21-Jul-2013 16:25:51
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% varargin   command line arguments to start (see VARARGIN)
    ...
    olpsLogo = imread('Resources/OLPS.JPG');
    axes(handles.logo);
    image(olpsLogo);
    axis off;
...
% --- Executes on button press in algotihmAnalyser.
function algotihmAnalyser_Callback(hObject, eventdata, handles)
% hObject    handle to algotihmAnalyser (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    tradingManager;


% --- Executes on button press in experimenter.
