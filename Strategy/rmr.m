function [run_ret, all_ret, day_ret, turno] = rmr(fid, data, varargins, opts)
% This file is an entry for the RMR strategy.
%
% function [cum_ret, cumprod_ret, daily_ret, daily_portfolio] ...
%           =  rmr(fid, data, varargins, opts)
%
...
% Original authors: Dingjiang Huang, Bin LI, Steven C.H. Hoi
% Contributors:
% Change log: 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[run_ret, all_ret, day_ret, turno] = rmr_run(fid, data, epsilon, tc,W, opts);
